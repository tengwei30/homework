  ...
  <div style="min-height: 600px">
    <el-card shadow="never" style="min-height: 400px;margin-bottom: 20px;padding: 0px 0px 20px 0px">
      <el-tabs v-model="activeTab" type="card" @tab-click="onSelect">
        <el-tab-pane :label="'粉丝 '+148" name="followers" style="padding: 5px">
          <div v-loading="followers.loading">
              <div v-if="followers.list.length">
                  <el-row style="min-height: 200px; ">
                      <!-- {{ followerslists }} -->
                      <el-col :span="8" v-for="(item,index) in followerslists" :key="'followers'+index" style="padding: 10px">
        ...
        <el-tab-pane :label="'关注 '+38" name="following" style="padding: 5px">
          <div >
